...
const uint32_t STAGE1_MAX_NEIGHBORS = 1;    // Stage 1 max neighbors from top 64
const uint32_t STAGE2_MAX_NEIGHBORS = 26;    // Stage 2 max neighbors from rank 65-128  
const uint32_t STAGE3_MAX_NEIGHBORS = 8;    // Stage 3 max neighbors from rank 129-256

const uint32_t STAGE2_SEARCH_LIST_SIZE = 128;    
const uint32_t STAGE3_START_RANK = 128;          // Stage 3 starts from rank 301 (index 300)
const uint32_t STAGE3_SEARCH_LIST_SIZE = 400;    // Stage 3: extended to rank 350 for more candidates

const float STAGE2_ALPHA = 1.2f;    // Stage 2 alpha for medium-quality candidates  
const float STAGE3_ALPHA = 0.5f;    // Stage 3 alpha for lower-quality candidates (less selective)
